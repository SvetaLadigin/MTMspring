...
typedef void(*printMapElement)(MapDataElement, void *context);
...
/**
* mapConvertToSortedListByValue: Gets the key elements as a list sorted by their values
* @param map
* 	Target map return key elements lists from and compare method
* @return
...
/**
* dumpMap: debug method for printing the map
* @param map
* 	Target map to print.
